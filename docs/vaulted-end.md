...
<style>
.md-main {
    background-image: url('/assets/vaulted-end/ship.png');
...
![](./assets/vaulted-end/vaults.png)

---

*A quality of life mod that makes Elytra easier to get in multiplayer.*

<span style="padding: 0 1rem;">[:curseforge:](https://www.curseforge.com/minecraft/mc-mods/vaulted-end)</span>
<span style="border-left: 2px solid currentColor; padding: 0 1rem;">[:modrinth:](https://modrinth.com/mod/vaulted-end)</span>
<span style="border-left: 2px solid currentColor; padding: 0 1rem;">[:github:](https://github.com/TheDeathlyCow/vaulted-end)</span>
