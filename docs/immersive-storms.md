...
Once that extraction was done I started adding new weather effects beyond sandstorms. I added blizzards for snowy biomes, fog for swamps, ambient wind particles to mountains and windy biomes, and black rain for the Pale Garden. Pale Gardens in particular I felt still had a bit too much colour coming from the blue tint of vanilla rain was the one remaining bit of colour that needed to be removed.